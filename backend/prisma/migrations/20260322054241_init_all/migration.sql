...
-- AddForeignKey
ALTER TABLE "role_permissions" ADD CONSTRAINT "role_permissions_module_key_fkey" FOREIGN KEY ("module_key") REFERENCES "system_modules"("key") ON DELETE RESTRICT ON UPDATE CASCADE;
