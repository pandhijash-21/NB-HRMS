...
class _ProfileScreenState extends ConsumerState<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildProfileHeader(BuildContext context, EmployeeProfile profile, bool isDark) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(
            color: isDark ? const Color(0xFFC5A059).withOpacity(0.18) : const Color(0xFFCFD8DC),
            width: 1.5,
          ),
        ),
      ),
        ...
        children: [
          Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: isDark ? const Color(0xFFC5A059).withOpacity(0.4) : const Color(0xFF263238).withOpacity(0.2),
                width: 3,
              ),
              boxShadow: [
                BoxShadow(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  profile.generalInfo?.designation.toUpperCase() ?? 'NO DESIGNATION ASSIGNED',
                  style: TextStyle(
                    fontSize: 12,
                    color: isDark ? const Color(0xFFD4C3A3) : const Color(0xFF607D8B),
                    fontWeight: FontWeight.w700,
                    letterSpacing: 0.8,
                  ),
                ),
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: isDark ? Colors.white70 : const Color(0xFF263238).withOpacity(0.7),
                  ),
                ),
                ...
                Row(
                  children: [
                    Icon(
                      ...
                      size: 13,
                      color: isDark ? Colors.white38 : const Color(0xFF607D8B).withOpacity(0.8),
                    ),
