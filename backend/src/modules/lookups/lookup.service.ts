...
export const LOOKUP_CATEGORIES = [
  ...
  { key: 'CONTRACTOR_TDS', label: 'Vendor TDS', description: 'TDS / TCS options for vendors' },
  { key: 'CONTRACTOR_TYPE', label: 'Type of Vendor', description: 'Agency, Contractor, Supplier, …' },
  { key: 'CONTRACTOR_ADDRESS_TYPE', label: 'Address Type', description: 'Billing, Office, Site, …' },
  { key: 'CONTRACTOR_COUNTRY', label: 'Vendor Country', description: 'Country for vendor locations' },
  { key: 'CONTRACTOR_STATE', label: 'Vendor State', description: 'State for vendor locations' },
  { key: 'CONTRACTOR_CITY', label: 'Vendor City', description: 'City for vendor locations' },
  { key: 'CONTRACTOR_DOCUMENT_TYPE', label: 'Vendor Document Type', description: 'PAN, GST, Agreement, …' },
  // Inventory catalog
  { key: 'INVENTORY_CATEGORY', label: 'Inventory Category', description: 'CCTV, Cement, Fabrication, …' },
  { key: 'INVENTORY_BRAND', label: 'Inventory Brand', description: 'Brands for inventory items' },
  { key: 'INVENTORY_UOM', label: 'Inventory UoM', description: 'Unit of measure for inventory' },
  { key: 'INVENTORY_SIZE', label: 'Inventory Size', description: 'Sizes for inventory items' },
  // Purchase request
  { key: 'PR_TYPE', label: 'PR Type', description: 'Purchase request types' },
  { key: 'PR_PRIORITY', label: 'PR Priority', description: 'Low, Medium, High' },
