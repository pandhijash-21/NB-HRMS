...
class EditAttendanceSettingsTab extends StatefulWidget {
  const EditAttendanceSettingsTab({super.key, required this.employeeId});

  final int employeeId;

  @override
  State<EditAttendanceSettingsTab> createState() => _EditAttendanceSettingsTabState();
}

class _EditAttendanceSettingsTabState extends State<EditAttendanceSettingsTab> {
  ...
  Future<void> _save() async {
    try {
      await context.read<AttendanceRepository>().updateEmployeeSettings(
        widget.employeeId,
        {
  ...
  Widget build(BuildContext context) {
    ...
    if (_error != null) {
      return Center(child: Text('Could not load settings: $_error'));
    }
