...
import { boqRouter } from './modules/erp-boq';
import { resourceRouter } from './modules/erp-resources';
import { purchaseRouter } from './modules/erp-purchase';
import { tenderRouter, tenderApplicationRouter } from './modules/erp-tenders';
import { dprRouter } from './modules/erp-dpr';
...
app.use('/api/erp/vendors', ...erpLicenseGuard, contractorRouter);
app.use('/api/erp/resources', ...erpLicenseGuard, resourceRouter);
app.use('/api/erp/purchase', ...erpLicenseGuard, purchaseRouter);
