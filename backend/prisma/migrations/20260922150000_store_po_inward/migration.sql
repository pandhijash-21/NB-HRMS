...
CREATE TABLE "erp_store_masters" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
...
CREATE TABLE "erp_store_inwards" (
    "id" TEXT NOT NULL,
    "purchase_order_id" TEXT NOT NULL,
...
CREATE TABLE "erp_store_inward_lines" (
    "id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "erp_purchase_orders_po_number_key" ON "erp_purchase_orders"("po_number");
CREATE INDEX "erp_store_masters_is_active_name_idx" ON "erp_store_masters"("is_active", "name");
CREATE INDEX "erp_purchase_orders_status_order_date_idx" ON "erp_purchase_orders"("status", "order_date");
CREATE INDEX "erp_purchase_orders_vendor_id_idx" ON "erp_purchase_orders"("vendor_id");
CREATE INDEX "erp_purchase_order_items_purchase_order_id_sort_order_idx" ON "erp_purchase_order_items"("purchase_order_id", "sort_order");
CREATE INDEX "erp_purchase_order_items_material_id_idx" ON "erp_purchase_order_items"("material_id");
CREATE INDEX "erp_store_inwards_purchase_order_id_inward_date_idx" ON "erp_store_inwards"("purchase_order_id", "inward_date");
CREATE INDEX "erp_store_inwards_store_id_inward_date_idx" ON "erp_store_inwards"("store_id", "inward_date");
CREATE INDEX "erp_store_inward_lines_inward_id_sort_order_idx" ON "erp_store_inward_lines"("inward_id", "sort_order");
CREATE INDEX "erp_store_inward_lines_purchase_order_item_id_idx" ON "erp_store_inward_lines"("purchase_order_item_id");
